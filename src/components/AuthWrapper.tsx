          ...
          <div className="bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-2xl p-6 sm:p-8 shadow-2xl space-y-5 text-left">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-indigo-950/70 hover:bg-indigo-900/80 text-indigo-200 border border-indigo-700/50 px-4 py-2.5 rounded-xl font-medium text-xs transition-colors cursor-pointer shadow-sm"
              >

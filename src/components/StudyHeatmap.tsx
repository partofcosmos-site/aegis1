                        ...
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <div className="flex items-center gap-1.5 shrink-0">
                            <button
                              ...
                              className="px-2 py-1 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-indigo-300 text-[11px] font-semibold rounded-lg border border-zinc-700/60 transition-colors flex items-center gap-1 cursor-pointer"
                              title="Edit Log"
                            >
                            ...
                            <button
                              ...
                              className="px-2 py-1 bg-zinc-800 hover:bg-red-950/60 text-zinc-300 hover:text-red-400 text-[11px] font-semibold rounded-lg border border-zinc-700/60 hover:border-red-800/60 transition-colors flex items-center gap-1 cursor-pointer"
                              title="Delete Log"
                            >
